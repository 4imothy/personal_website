...
function Title() {
    return <img className={styles.title} src={TitleImg} alt="Fishy Feeder" />;
}
...
function Text() {
    return (
        <div className={styles.text}>
            <p>
                Fishy Feeder is a fast-paced game I made over the course of freshman year. You take
                control of a fish that has to feed other fishes before they eat you. The game
                resizes to fit any screen and keps track of your highscores.
                <br />
                <br />
                You can play the game below or follow the link below to play. It is built with
